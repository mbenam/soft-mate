...
| `m8_tests` | `tests/*` | Catch2 v3 + `m8_engine` | 266 test cases across 32 files (static `TEST_CASE` count, 2026-08-12 — see `status.md` "Tests" for provenance; last recorded *run* was 147/147 on 2026-07-17's tree). |
